...
function solvecubature!(cub::SymCub{T}, q::Int, mask::AbstractArray{Int64,1};
  ...
  iter_pso = 0
  iter_lma = 0
  fmin,xinit,k = Optimizer.levenberg_marquardt(Cubature.cubatureresidual,cub,q,mask, xinit=xinit, maxiter=1000, tol=tol, nu=1e5, verbose=1)
  iter_lma+=k
  # v = xinit
  # println(fmin)
  # println(xinit)
...
function getTetCubatureOmegaLG(q::Int, T=Float64;
  ...
  elseif q <= 10
    ...
    #                               numS1111 = 1, 
    #                               centroid = false)
    # SymCubatures.setparams!(cub, T[0.011707565792405636, 0.997606533454002, 0.9427720464593494, 0.4087356415685378, 0.5476478490651255, 0.9834189489706829, 0.7380195094641262, 0.670570710126436, 0.04145788450970861, 1.6026850310605087, 0.16775941403638397, 0.04327629135396544, 0.3692655812548793, 0.0653741435559605, 0.8197186964410567, 0.06035023790634342, 0.6195880514082778, 1.206305621443911, 0.12580098597910713])
