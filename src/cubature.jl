...
function solvecubature!(cub::SymCub{T}, q::Int, mask::AbstractArray{Int64,1};
  ...
  iter_pso = 0
  iter_lma = 0
  fmin,xinit,k = Optimizer.levenberg_marquardt(Cubature.cubatureresidual,cub,q,mask, xinit=xinit, maxiter=200, tol=tol, nu=10.0, verbose=0)
  iter_lma+=k
  # println(fmin)
  # println(xinit)
  ...
  # verbose=true
  for i = 1:5000
    fmin1,v1,_,_,k_pso,nperturb = Optimizer.pso(Cubature.cubatureresidual, n, cub, q, mask,xinit=xinit, np=10,maxiter=200, 
